...
def refframe_file_data_rg(filename, df_index, dataframe, Ncirc):
    '''
    '''
...
def refframe_file_data_detailed(filename, df_index, dataframe, Ncirc, loop_length, start_bp_id, midloop_bp_id, end_bp_id):
    '''
    '''
    rfdf    = dna_analysis.df_read_refframe_origins(filename)
    ...
    WE, WA, WB, WG = dna_analysis._loop_westcott_angles(rfdf, rfnorms, loop_length, start_bp_id, midloop_bp_id, end_bp_id)
    ...
    P1, P2, P3 = dna_analysis._loop_pinching(rfdf, Ncirc, start_bp_id, end_bp_id)
